...
// ========================================================
// VARIABEL KONFIGURASI GLOBAL (KEMBALI KE PONDASI ASLI YANG KONEK)
// ========================================================
...
// 🎯 PORT XRAY UTAMA (Tempat Quick Tunnel Lari Menembak Langsung)
...
async function downloadFilesAndRun() {
  ...
  // 🎯 QUICK TUNNEL MURNI LANGSUNG MENEMBAK KE PORT 8001
...
// 🔥 HAPUS TOTAL MULTIPLEXER AGAR KONEKSI QUICK TUNNEL KEMBALI TEMBUS KE PORT 8001
server.listen(PORT, () => {
    ...
    // Auto-loop pencari domain Cloudflare biar langsung nongol
    setInterval(() => {
        extractDomains();
    }, 3000);
});
